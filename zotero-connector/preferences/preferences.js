...
Zotero_Preferences.Components.ProxyPreferences = class ProxyPreferences extends React.Component {
  ...
  render() {
    ...
    if (Zotero.isBrowserExt) {
      autoRecognise = React.createElement("span", null, React.createElement("label", null, React.createElement("input", {
        type: "checkbox",
        disabled: !this.state.transparent,
        onChange: this.handleCheckboxChange,
        name: "autoRecognize",
        defaultChecked: this.state.autoRecognize
      }), "\xA0Automatically detect new proxies"), React.createElement("br", null));
    }
    ...
    }), "\xA0Enable proxy redirection"), React.createElement("br", null), React.createElement("div", {
      style: {
        marginLeft: "1em"
      }
    ...
    }), "\xA0Show a notification when redirecting through a proxy"), React.createElement("br", null), autoRecognise, React.createElement("br", null), React.createElement("label", null, React.createElement("input", {
      type: "checkbox",
      disabled: !this.state.transparent,
      onChange: this.handleCheckboxChange,
      name: "disableByDomain",
      defaultChecked: this.state.disableByDomain
    }), "\xA0Disable proxy redirection when my domain name contains", React.createElement("span", null, "*")), React.createElement("br", null), React.createElement("input", {
      style: {
        marginTop: "0.5em",
        marginLeft: "1.5em"
      },
...
Zotero_Preferences.Components.Proxies = class Proxies extends React.PureComponent {
  ...
  renderProxySettings() {
    ...
    }), "\xA0Automatically associate new hosts"), React.createElement("br", null), React.createElement("label", null, React.createElement("input", {
      type: "checkbox",
      name: "dotsToHyphens",
      onChange: this.handleCheckboxChange,
      checked: currentProxy.dotsToHyphens
    }), "\xA0Automatically convert between dots and hyphens in proxied hostnames"), React.createElement("br", null)), React.createElement("p", {
      style: {
        display: "flex",
        alignItems: "center"
      }
...
Zotero_Preferences.Components.MIMETypeHandling = class MIMETypeHandling extends React.Component {
  ...
  render() {
    ...
    }), "\xA0Import BibTeX/RIS/Refer files into Zotero"), React.createElement("br", null)), React.createElement("div", {
      style: {
